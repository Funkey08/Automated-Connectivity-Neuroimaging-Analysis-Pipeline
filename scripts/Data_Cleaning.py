...
df_separate.to_csv("C:/Users/fmava/Downloads/EEG Learning/MDD Dataset Practice/connectivity_separate.csv")
...
df_combined.to_csv("C:/Users/fmava/Downloads/EEG Learning/MDD Dataset Practice/connectivity_combined.csv", index=False)
...
new_df.to_csv("C:/Users/fmava/Downloads/EEG Learning/MDD Dataset Practice/connectivity_average_separate.csv")
...
# Save to CSV
df_averaged.to_csv("C:/Users/fmava/Downloads/EEG Learning/MDD Dataset Practice/connectivity_average_combined.csv", index=False)
...
# Load the CSV files
df_raw = pd.read_csv("C:/Users/fmava/Downloads/EEG Learning/MDD Dataset Practice/connectivity_combined.csv")
df_averaged = pd.read_csv("C:/Users/fmava/Downloads/EEG Learning/MDD Dataset Practice/connectivity_average_combined.csv")

# Merge on 'patient_id'
df_combined = pd.merge(df_raw, df_averaged, on='patient_id', how='outer')

# Save the merged DataFrame
df_combined.to_csv("C:/Users/fmava/Downloads/EEG Learning/MDD Dataset Practice/connectivity_raw_and_average_combined.csv", index=False)
