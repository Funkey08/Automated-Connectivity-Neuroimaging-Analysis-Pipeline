...
TO_ANALYZE = pd.read_csv("C:/Users/fmava/Downloads/EEG Learning/MDD Dataset Practice/connectivity_combined_patient.csv")
...
results_df.to_csv("C:/Users/fmava/Downloads/EEG Learning/MDD Dataset Practice/t_test_results.csv", index=True)
