...
folder_path_connectivity = PROCESSED_DIR
...
df_separate.to_csv(os.path.join(PROCESSED_DIR, "connectivity_pairwise.csv"), index=False)
...
df_filtered.to_csv(os.path.join(PROCESSED_DIR, "connectivity_pairwise_filtered.csv"), index=False)
