...
TO_ANALYZE = pd.read_csv(os.path.join(PROCESSED_DIR, connectivity_pairwise_filename))
...
merged_df.to_csv(os.path.join(PROCESSED_DIR, 'connectivity_pairwise_patient.csv'), index=False)
